...
val LightCustomColorsPalette = CustomColorsPalette(
    buttonColorDefault =  CoralPink,
    buttonTransition = Crimson,
    buttonColorPressed =  Crimson,
    ...
    imageTutorialInit = Crimson,
    imageTutorialTarget = CoralPink,
