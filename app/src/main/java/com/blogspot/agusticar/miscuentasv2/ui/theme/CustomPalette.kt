...
val LightCustomColorsPalette = CustomColorsPalette(
    ...
    buttonTransition = DeepBrown,
    buttonColorPressed =  DeepBrown,
    disableButton = LightGrey,
    ...
    indicatorSelected =  DeepBrown,
    imageBackground = DarkPeach,
